...
class Lesson(models.Model):
    ...
    video_file_360p  = models.FileField(upload_to='lessons/videos/360p/',  blank=True, null=True)
    video_file_480p  = models.FileField(upload_to='lessons/videos/480p/',  blank=True, null=True)
    video_file_720p  = models.FileField(upload_to='lessons/videos/720p/',  blank=True, null=True)
    video_file_1080p = models.FileField(upload_to='lessons/videos/1080p/', blank=True, null=True)
